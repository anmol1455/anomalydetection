...
###### This file gives information on how to use the implementation files of "Anomaly Detection in Networks Using Machine Learning" ( A project submitted for the degree of Bachelor of Science in Computer Networks and Security written by Anmol Singh )
...
# 2 - Statistics
This step consists of a single file ([statistics.ipynb](https://github.com/anmol1455/anomalydetection/blob/main/02_statistics.ipynb)). This program examines the file "all_data.csv" and prints the statistics of attack and benign registry on this screen. It is not a prerequisite for any file. It only gives information.
...
####   a - [feature_selection_for_attack_files.ipynb](https://github.com/anmol1455/anomalydetection/blob/main/04_1_feature_selection_for_attack_files.ipynb)
...
####  b - [feature_selection_for_all_data.ipynb](https://github.com/anmol1455/anomalydetection/blob/main/04_2_feature_selection_for_all_data.ipynb)
...
####  a - [machine_learning_implementation_for_attack_files.ipynb](https://github.com/anmol1455/anomalydetection/blob/main/05_1_machine_learning_implementation_for_attack_files%20.ipynb)
...
####  b - [machine_learning_implementation_with_18_feature.ipynb](https://github.com/anmol1455/anomalydetection/blob/main/05_2_machine_learning_implementation_with_18_feature.ipynb)
...
####  c -  [machine_learning_implementation_with_7_feature.ipynb](https://github.com/anmol1455/anomalydetection/blob/main/05_3_machine_learning_implementation_with_7_feature.ipynb)
...
####  d -  [ml_f_measure_comparison.ipynb](https://github.com/anmol1455/anomalydetection/blob/main/05_4_ml_f_measure_comparison.ipynb)
...
####  e-  [machine_learning_implementation_final.ipynb](https://github.com/anmol1455/anomalydetection/blob/main/05_4_ml_f_measure_comparison.ipynb)
...
```
@MastersThesis{anmol1455,
    author = {Anmol},
    title = {{Anomaly Detection in Networks Using Machine Learning}},
    institution = {Computer Science and Engineering - CSE},
